...
class DBManger {
  ...
  @override
  Future<int> update(String tableName, Map<String, dynamic> row, String whereClause, List<dynamic> whereArgs)async {
    // Implementation specific to the images table
Database localDB = await dbObject;
    return localDB.update(tableName, row, where: whereClause, whereArgs: whereArgs);
  }
}
