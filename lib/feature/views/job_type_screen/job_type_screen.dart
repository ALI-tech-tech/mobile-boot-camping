...
class _JobTypeScreenState extends State<JobTypeScreen> {
                                          ...
                                          ? AppDecoration.outlinePrimary
                                              .copyWith(
                                                  borderRadius:
                                                      BorderRadiusStyle
                                                          .roundedBorder24)
                                          : AppDecoration.outlineOnPrimary
                                              .copyWith(
                                                  borderRadius:
                                                      BorderRadiusStyle
                                                          .roundedBorder24),
  ...
  onTapcontnuetocompany(BuildContext context, Object arg) {
    Navigator.pushNamed(context, AppRoutes.completecompanysignUpScreen, arguments: arg);
  }

  onTapcontnuetoseeker(BuildContext context, Object arg) {
    Navigator.pushNamed(context, AppRoutes.completeseekersignUpScreen, arguments: arg);
  }
